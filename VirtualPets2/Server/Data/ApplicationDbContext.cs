 ...
 /*       public DbSet<CarnivoreEntity> Meat { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AnimalEntity>()
                ...
                new AnimalEntity { Id = 13,  Title = "Hyena", Type = "Feline", Price = 450.45, Dwelling = "Grasslands/Forest/Savannahs", Diet = 0 },
            ...
            modelBuilder.Entity<FoodEntity>()
                ...
                new FoodEntity { Id = 66, Name = "Chicken Skewers", Price = 15, Type = 2 },
